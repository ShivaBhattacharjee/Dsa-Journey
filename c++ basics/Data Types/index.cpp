...
#include <iostream>
using namespace std; // used it so that i dont have to write std::string or std::getline
int main()
{
    int age = 25;
    ...
    string str;        // however it cant store the spaces in order to store a sentence that has spaces we have to use getline
    getline(cin, str); // If we dont use getline we will have to assign different values to variables like
    string idk = "Name"; // in string we use " " and in char we use ' '
    string a, b, c;
    cin >> a >> b >> c; //it will end up taking a heck lot of space 
    cout << a << b << c;
    cout << str;
